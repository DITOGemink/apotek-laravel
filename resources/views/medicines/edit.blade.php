                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="category_id"
                                ...
                                @foreach($categories as $c)
                                    <option value="{{ $c->id }}"
                                        {{ old('category_id', $medicine->category_id) == $c->id ? 'selected' : '' }}>
                                        {{ $c->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date"
                                   name="exp_date"
                                   value="{{ old('exp_date', $medicine->exp_date) }}"
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mt-2">
                            <img id="preview-new-image"
                                 src="{{ $medicine->image_path ? asset('storage/'.$medicine->image_path) : 'https://via.placeholder.com/120x120?text=Preview' }}"
